...
#include <time.h> /* Medida del tiempo */
...
{
		// Toma origen de tiempos
		clock_t mi_inicio_tiempo = clock();
    ...
    if (argc < 3) {
        ...
        //}
				...
				// Muestra el tiempo transcurrido desde el inicio de tiempo
        std::cout << "Tiempo empleado: " << (double)( clock() - mi_inicio_tiempo )/CLOCKS_PER_SEC << std::endl;
